 ...
 public class Student {
     ...
     public void cancel_Membership() {
         membership = false;
         System.out.println("Now the membership value is: " + membership);
     }
     ...
     public int adjustAge(int add, int minus) {
     ...
     public String doIT() {
         String str = null;//need to initilize due to conditional statement
